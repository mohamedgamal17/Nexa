...
//        {
//            builder.ToTable(DocumentAttachmentTableConsts.TableName);

//            builder.Property(x => x.Id);

//            builder.Property(x => x.Id).HasMaxLength(DocumentAttachmentTableConsts.IdLength);

//            builder.Property(x => x.KycAttachmentId).IsRequired(false).HasMaxLength(DocumentAttachmentTableConsts.KycAttachmentIdLength);
...
//            builder.HasIndex(x => x.KycAttachmentId);

//            builder.HasOne<Document>().WithMany(x => x.Attachments);
//        }
//    }
//}
