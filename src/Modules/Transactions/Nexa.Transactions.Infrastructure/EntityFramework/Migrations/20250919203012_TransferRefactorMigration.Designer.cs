...
namespace Nexa.Transactions.Infrastructure.EntityFramework.Migrations
{
    ...
    [Migration("20250919203012_TransferRefactorMigration")]
    partial class TransferRefactorMigration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Nexa.Transactions.Domain.Transfers.BankTransfer", b =>
                {
                    ...
                    b.Property<string>("FundingResourceId")
                        .IsRequired()
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)");

                    b.HasIndex("FundingResourceId");
