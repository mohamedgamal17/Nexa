...
namespace Nexa.Application.Tests.Utilites
{
    public class TestOutputLogger : ILogger
    {
        ...
        public void Log<TState>(LogLevel logLevel, EventId eventId, TState state, Exception exception, Func<TState, Exception, string> formatter)
        {
            ...
            var currentContext = NUnit.Framework.Internal.TestExecutionContext.CurrentContext;

            if (currentContext.CurrentTest is NUnit.Framework.Internal.TestMethod)
